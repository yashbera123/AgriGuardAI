...
from services.prediction_logger import HISTORY_COLUMNS
...
def render_analytics_dashboard(history_df):
    ...
    disease_counts = (
        history["Disease Name"].fillna("Unknown").value_counts().reset_index()
    )
    ...
    if not timeline.empty:
        ...
        st.warning(
            "Prediction timeline is unavailable because timestamps could not be read."
        )
